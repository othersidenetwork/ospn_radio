...
foreach ($crons as $cron) {
	...
	switch ($cron['cron']) {
		case 'jingles':
			die("/home/yannick/radio/jingles/outro_zoe_1.mp3");
			break;
		default:
			break;
	}
...
die("/home/yannick/radio/music/" . $track['ufid'] . ".mp3");
// SELECT id, duration, abs(duration - 300) FROM `tracks` WHERE duration BETWEEN 295 and 320 order by abs(duration - 300), rand()